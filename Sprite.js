class Sprite {
    ...
    draw(ctx, cameraAnchor) {
        const x = this.gameObject.x - 8 + utils.withGrid(10.5) - cameraAnchor.x
        const y = this.gameObject.y - 18 + utils.withGrid(6) - cameraAnchor.y
